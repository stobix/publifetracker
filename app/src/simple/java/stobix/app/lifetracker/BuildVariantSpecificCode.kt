...
class BuildVariantSpecificCode {
    companion object {
        @JvmStatic fun onLoad(c: Context) {
        }

        @JvmStatic fun handleMenu(c:MainActivity, item:Int ) =
            when (item) {
                /*
                ...
                R.id.show_stats -> {
                    ...
                    thread(start=true) {
                        ...
                        if (s == 0L)
                            ...
                            message += "\t" + c.getString(R.string.stat_window_bs_entries) + levels.size + "\n"
                        }
                ...
                R.id.action_colors -> {
                    val colorEditorHandler = MainActivity.MainHandler(c) { mainActivity, bundle ->
                        Log.d("graph", "got bundle")
                ...
                R.id.show_sugar_weekly -> {
                    ...
                    val newGraphHandler = MainActivity.MainHandler(c
                    ...
                    thread(start=true) {
                        ...
                        Log.d("veckografer","sockervärden: ${allSugarBuckets.size} viktvärden: ${allWeightBuckets.size}")
