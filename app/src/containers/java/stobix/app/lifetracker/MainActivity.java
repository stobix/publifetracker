...
public class MainActivity extends AppCompatActivity
        ...
        FileActions.FileOpenHandler
    {
        ...
        private AltAltContainerDao containerDao;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            */
            ...
            Runnable initiateDB = () -> {
                ...
                AltAltDatabase containerDb =
                        Room.databaseBuilder(
                                getApplicationContext(),
                                AltAltDatabase.class,
                                "containers.db").build();


                dao = db.userDao();

                containerDao = containerDb.containerDao();

                CSubmission s = CSubmission.testCase();
                s.submitToDb(containerDao);
